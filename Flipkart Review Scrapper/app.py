...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            product_name = flipkart_html.find_all('div', {'class': "_4rR01T"})
            box = bigboxes[0] #  taking the first iteration (for demo)
            product_name1 = product_name[0].text
            ...
            for commentbox in commentboxes[:-1]:
                ...
                mydict = {"Product": product_name1, "Name": name, "Rating": rating, "CommentHead": commentHead,
